package io.github.heyuch.codegen.cli;
 ...
 */
@AnalyzeClasses(
        packages = {"io.github.heyuch.codegen.cli", "io.github.heyuch.codegen.core", "io.github.heyuch.codegen.tree"},
...
class ArchitectureTest {
    ...
    static final ArchRule cliOnlyUsesCodegenFacade = noClasses()
            .that()
            .resideInAPackage("io.github.heyuch.codegen.cli..")
            .should()
            .dependOnClassesThat()
            .resideInAnyPackage(
